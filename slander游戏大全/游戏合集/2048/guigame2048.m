...
%==========================================================================
startGame()
filename='2048Game.fig';
saveas(GUI.figSt,filename)
    function startGame(~,~)
        GUI.figSt=figure('units','pixels',...
            ...
            'menubar','none',...
            'resize','off');
        GUI.axesSt=axes('parent',GUI.figSt,'position',[0 0 1 1],...
                    'XLim', [0 400],...
                    'YLim', [0 575],...
                    'NextPlot','add',...
                    'layer','bottom',...
                    ...
                    'XTick',[], ...
                    'YTick',[]);
        stPic=imread('start.png');
        GUI.stPicHdl=image([0 400],...
                       [0 575],...
                       stPic,...                            
                       'ButtonDownFcn',@pushSt,'parent',GUI.axesSt);% 'alphaData',flipud(temp_card.Alpha),...
        function pushSt(~,~)
            close all;
            clc;clear;
            pause(0.1)
